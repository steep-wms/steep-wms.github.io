...
function Picture({ type }: { type: "dark" | "light" }) {
  return (
    ...
    >
      <source
        srcSet={`/images/webui-${type}-800.webp 800w, /images/webui-${type}-1280.webp 1280w, /images/webui-${type}-2560.webp 2560w`}
      ...
      />
      <img
        src={`/images/webui-${type}-800.png`}
        srcSet={`/images/webui-${type}-800.png 800w, /images/webui-${type}-1280.png 1280w, /images/webui-${type}-2560.png 2560w`}
        sizes="(max-width: 992px) 100vw, 60vw"
