...
const DownloadButtons = () => (
  <div className="download-btns">
    ...
    >
      <Download className="feather" /> Download Steep {pkg.version} (binaries)
    </a>
    <a href="https://hub.docker.com/r/steep/steep/" className="btn">
      <SimpleIcon icon={siDocker} className="simple-icon" /> Docker image
    </a>
    <a href="https://github.com/steep-wms/steep" className="btn">
      <GitHub className="feather" /> Source code
    </a>
