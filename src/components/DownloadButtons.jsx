...
export default () => (
  <div className="download-btns">
    <a href="https://github.com/steep-wms/steep/releases/download/v5.1.0/steep-5.1.0.zip" className="btn btn-primary">
      <Download className="feather"/> Download Steep 5.1.0 (binaries)</a>
