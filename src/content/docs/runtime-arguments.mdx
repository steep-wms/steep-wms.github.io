...
| dataType<br/>*(optional)*    | string | The type of the parameter value. Typically `"string"` or `"boolean"`. The same rules apply as for <ScrollLink href="#service-parameters">service parameters</ScrollLink>.
