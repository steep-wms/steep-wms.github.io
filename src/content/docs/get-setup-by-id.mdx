...
Get information about a single <ScrollLink href="#setups">setup</ScrollLink>.
...
| 404          | The setup cannot be found or setups are unavailable because <ScrollLink href="#cloud-connection">cloud configuration</ScrollLink> is disabled |
