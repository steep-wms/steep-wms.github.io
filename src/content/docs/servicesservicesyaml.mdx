...
*Note:* The path to the services configuration file can be configured with
the item `steep.cloud.setups.file` in Steep's <DocsLink href="#cloud-connection">cloud
