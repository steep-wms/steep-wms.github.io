...
| Metric                                                 | Description
| ------------------------------------------------------ | -----------
| steep\_<wbr />remote_<wbr />agents                     | The number of registered remote agents
| steep\_<wbr />controller\_<wbr />process_<wbr />chains | The number of process chains the controller is currently waiting for
