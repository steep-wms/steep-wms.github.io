...
> A <ScrollLink href="#retry-policies">retry policy</ScrollLink> that specifies
> how many attempts should be made to create a VM from a certain
> <ScrollLink href="#setups">setup</ScrollLink> (if creation fails) as well as
...
> <ScrollLink href="#setups">setup</ScrollLink> has been reached (see
...
> locked, specified as a <ScrollLink href="#durations">duration</ScrollLink>.
