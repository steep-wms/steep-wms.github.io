...
| ------------------------- | ------ | -----------
| locator                   | string | The property in which the match was found. Possible values are `errorMessage`, `id`, `name`, `requiredCapabilities`, `source`, `status`, `startTime`, `endTime`. See the description of the <DocsLink href="#submissions">submission</DocsLink> and <DocsLink href="#process-chains">process chain</DocsLink> data models for more information about these properties.
