...
| PROVISIONING    | The VM has been created and is currently being provisioned (i.e. <ScrollLink href="#provisioning-scripts">provisioning scripts</ScrollLink> defined in the VM's <ScrollLink href="#setups">setup</ScrollLink> are being executed and the Steep agent is being deployed)
