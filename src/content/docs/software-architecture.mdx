...
import ArchitectureLight from "assets/architecture-light.svg"
...
<img className="max-w-[16rem] mx-auto dark:hidden" src={Architecture} />
<img className="max-w-[16rem] mx-auto hidden dark:block" src={ArchitectureLight} />
