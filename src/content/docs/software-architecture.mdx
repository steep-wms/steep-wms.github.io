...
<img className="docs-image image-architecture" src={Architecture} />
...
disabled in a given instance (see the <DocsLink href="#configuration">configuration options</DocsLink> 
