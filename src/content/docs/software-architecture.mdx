import Architecture from "assets/architecture-inlined-styles.svg?source"
import ArchitectureLight from "assets/architecture-light-inlined-styles.svg?source"
...
<div className="max-w-[16rem] mx-auto my-10 dark:hidden" dangerouslySetInnerHTML={{__html: Architecture}} />
<div className="max-w-[16rem] mx-auto my-10 hidden dark:block" dangerouslySetInnerHTML={{__html: ArchitectureLight}} />
