...
<div className="grid grid-cols-[75%] xs:grid-cols-[50%] sm:grid-cols-2 md:grid-cols-3 gap-4 my-8 justify-center [&_img]:m-0 [&_picture]:m-0">
  <div className="flex flex-col">
    ...
    />
    <div className="text-center mt-2 font-normal">No tiling</div>
  </div>
  <div className="flex flex-col">
    <Tiles
      n={2}
    ...
    />
    <div className="text-center mt-2 font-normal">2&times;2 tiles</div>
  </div>
  <div className="flex flex-col">
    <Tiles
      n={5}
    ...
    />
    <div className="text-center mt-2 font-normal">5&times;5 tiles</div>
  </div>
</div>
