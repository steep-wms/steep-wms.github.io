...
| status<br/>*(optional)* | If this parameter is defined, Steep will only return submissions with the given status. See the list of <ScrollLink href="#submission-status">submission statuses</ScrollLink> for valid values. Otherwise, it will return all submissions from the database. |
...
Update a submission. The request body is a JSON object with the <ScrollLink href="#submissions">submission properties</ScrollLink>
...
Create a new submission. The request body contains the <ScrollLink href="#workflows">workflow</ScrollLink>
to execute.

If the operation was successful, the response body contains
the created <ScrollLink href="#submissions">submission</ScrollLink>.
