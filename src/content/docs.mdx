...
In order to understand how Steep works, we first have to learn how it
transforms scientific workflow graphs to executable units. We then have a look
at its software architecture.

(The description in this section is based on our publication: Krämer, M. (2020).
...
workflow in an extended Petri Net notation proposed by van der
[Aalst and van Hee (2004)](https://doi.org/10.7551/mitpress/7301.001.0001).
