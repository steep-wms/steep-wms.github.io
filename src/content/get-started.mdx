...
<pre>
<code class="hljs language-bash"><span class="hljs-built_in">cd</span> steep-{pkg.version}<br />
bin/steep
</code>
</pre>
...
<pre>
<code class="hljs language-bash">docker run --name steep -d --rm -p 8080:8080 \<br />
<React.Fragment>&#32;&#32;&#32;&#32;</React.Fragment>-e STEEP_HTTP_HOST=0.0.0.0 steep/steep:{pkg.version}
</code>
</pre>
