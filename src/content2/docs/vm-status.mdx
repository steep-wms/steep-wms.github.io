...
The following table shows the statuses a <DocsLink href="#vms">VM</DocsLink>
can have:

| Status          | Description
| --------------- | -----------
| CREATING        | The VM is currently being created
| PROVISIONING    | The VM has been created and is currently being provisioned (i.e. <DocsLink href="#provisioning-scripts">provisioning scripts</DocsLink> defined in the VM's <DocsLink href="#setups">setup</DocsLink> are being executed and the Steep agent is being deployed)
