...
const pdfs = [
  [
    "https://michelkraemer.com/publications/2024/Kraemer,%20Bormann,%20Wuerz,%20Kocon,%20Frechen,%20Schmid%20-%20A%20cloud-based%20data%20processing%20and%20visualization%20pipeline%20for%20the%20fibre%20roll-out%20in%20Germany.pdf",
    "kraemer-et-al-2024",
  ],
  // [
...
for (let pdf of pdfs) {
  ...
  for (let i = 1; i <= 3; ++i) {
    ...
    await exec(
      `/opt/homebrew/opt/mozjpeg/bin/cjpeg -quality 60 "${n}.png" > "${n}.jpg"`,
    )
